...
Termo000.hex:     file format ihex


Disassembly of section .sec1:

00000000 <.sec1>:
   0:	35 c0       	rjmp	.+106    	;  0x6c
  ...
  22:	a4 d3       	rcall	.+1864   	;  0x76c
  24:	00 d5       	rcall	.+2560   	;  0xa26
  26:	f0 d9       	rcall	.-3104   	;  0xfffff408
  28:	22 da       	rcall	.-3004   	;  0xfffff46e
  2a:	12 db       	rcall	.-2524   	;  0xfffff650
  2c:	20 8d       	ldd	r18, Z+24	; 0x18
  2e:	14 af       	std	Z+60, r17	; 0x3c
  30:	00 3e       	cpi	r16, 0xE0	; 224
  32:	51 49       	sbci	r21, 0x91	; 145
  34:	45 3e       	cpi	r20, 0xE5	; 229
  36:	00 00       	nop
  38:	42 7f       	andi	r20, 0xF2	; 242
  3a:	40 00       	.word	0x0040	; ????
  3c:	00 42       	sbci	r16, 0x20	; 32
  3e:	61 51       	subi	r22, 0x11	; 17
  40:	49 46       	sbci	r20, 0x69	; 105
  42:	00 21       	and	r16, r0
  44:	41 45       	sbci	r20, 0x51	; 81
  46:	4b 31       	cpi	r20, 0x1B	; 27
  48:	00 18       	sub	r0, r0
  4a:	14 12       	cpse	r1, r20
  4c:	7f 10       	cpse	r7, r15
  4e:	00 27       	eor	r16, r16
  50:	45 45       	sbci	r20, 0x55	; 85
  52:	45 39       	cpi	r20, 0x95	; 149
  54:	00 3c       	cpi	r16, 0xC0	; 192
  56:	4a 49       	sbci	r20, 0x9A	; 154
  58:	49 30       	cpi	r20, 0x09	; 9
  5a:	00 01       	movw	r0, r0
  5c:	71 09       	sbc	r23, r1
  5e:	05 03       	mulsu	r16, r21
  60:	00 36       	cpi	r16, 0x60	; 96
  62:	49 49       	sbci	r20, 0x99	; 153
  64:	49 36       	cpi	r20, 0x69	; 105
  66:	00 06       	cpc	r0, r16
  ...
  84:	f8 d0       	rcall	.+496    	;  0x276
  86:	98 c1       	rjmp	.+816    	;  0x3b8
  ...
  a2:	af 93       	push	r26
  a4:	bf 93       	push	r27
  a6:	20 91 62 00 	lds	r18, 0x0062	;  0x800062
  aa:	30 91 63 00 	lds	r19, 0x0063	;  0x800063
  ae:	84 b1       	in	r24, 0x04	; 4
  b0:	95 b1       	in	r25, 0x05	; 5
  b2:	67 e2       	ldi	r22, 0x27	; 39
  b4:	70 e0       	ldi	r23, 0x00	; 0
  b6:	5b d1       	rcall	.+694    	;  0x36e
  b8:	63 e6       	ldi	r22, 0x63	; 99
  ba:	70 e0       	ldi	r23, 0x00	; 0
  bc:	69 d1       	rcall	.+722    	;  0x390
  be:	26 0f       	add	r18, r22
  c0:	37 1f       	adc	r19, r23
  c2:	30 93 63 00 	sts	0x0063, r19	;  0x800063
  c6:	20 93 62 00 	sts	0x0062, r18	;  0x800062
  ca:	80 91 64 00 	lds	r24, 0x0064	;  0x800064
  ce:	90 91 65 00 	lds	r25, 0x0065	;  0x800065
  d2:	01 96       	adiw	r24, 0x01	; 1
  d4:	90 93 65 00 	sts	0x0065, r25	;  0x800065
  d8:	80 93 64 00 	sts	0x0064, r24	;  0x800064
  dc:	bf 91       	pop	r27
  de:	af 91       	pop	r26
  e0:	9f 91       	pop	r25
  e2:	8f 91       	pop	r24
 ...
 116:	01 c0       	rjmp	.+2      	;  0x11a
 118:	44 0f       	add	r20, r20
 11a:	0a 94       	dec	r0
 11c:	ea f7       	brpl	.-6      	;  0x118
 11e:	47 ff       	sbrs	r20, 7
 120:	02 c0       	rjmp	.+4      	;  0x126
 122:	c0 9a       	sbi	0x18, 0	; 24
 124:	01 c0       	rjmp	.+2      	;  0x128
 ...
 134:	71 f7       	brne	.-36     	;  0x112
 136:	c0 9a       	sbi	0x18, 0	; 24
 138:	c2 9a       	sbi	0x18, 2	; 24
 13a:	c2 98       	cbi	0x18, 2	; 24
 13c:	08 95       	ret
 13e:	dc df       	rcall	.-72     	;  0xf8
 140:	88 e7       	ldi	r24, 0x78	; 120
 142:	e4 df       	rcall	.-56     	;  0x10c
 144:	80 e0       	ldi	r24, 0x00	; 0
 146:	e2 cf       	rjmp	.-60     	;  0x10c
 148:	dc cf       	rjmp	.-72     	;  0x102
 14a:	cf 93       	push	r28
 14c:	df 93       	push	r29
 14e:	1f 92       	push	r1
 ...
 156:	f3 df       	rcall	.-26     	;  0x13e
 158:	89 81       	ldd	r24, Y+1	; 0x01
 15a:	d8 df       	rcall	.-80     	;  0x10c
 15c:	0f 90       	pop	r0
 15e:	df 91       	pop	r29
 160:	cf 91       	pop	r28
 162:	cf cf       	rjmp	.-98     	;  0x102
 164:	c9 df       	rcall	.-110    	;  0xf8
 166:	88 e7       	ldi	r24, 0x78	; 120
 168:	d1 df       	rcall	.-94     	;  0x10c
 16a:	80 e4       	ldi	r24, 0x40	; 64
 16c:	cf cf       	rjmp	.-98     	;  0x10c
 16e:	c9 cf       	rjmp	.-110    	;  0x102
 170:	1f 93       	push	r17
 172:	cf 93       	push	r28
 174:	df 93       	push	r29
 ...
 184:	84 91       	lpm	r24, Z
 186:	e1 df       	rcall	.-62     	;  0x14a
 188:	21 96       	adiw	r28, 0x01	; 1
 18a:	1c 13       	cpse	r17, r28
 18c:	fa cf       	rjmp	.-12     	;  0x182
 18e:	df 91       	pop	r29
 190:	cf 91       	pop	r28
 192:	1f 91       	pop	r17
 194:	08 95       	ret
 ...
 1e2:	d9 df       	rcall	.-78     	;  0x196
 1e4:	bf df       	rcall	.-130    	;  0x164
 1e6:	c0 e0       	ldi	r28, 0x00	; 0
 1e8:	d1 e0       	ldi	r29, 0x01	; 1
 1ea:	8e 2d       	mov	r24, r14
 1ec:	8f df       	rcall	.-226    	;  0x10c
 1ee:	8f 2d       	mov	r24, r15
 1f0:	8d df       	rcall	.-230    	;  0x10c
 1f2:	80 2f       	mov	r24, r16
 1f4:	8b df       	rcall	.-234    	;  0x10c
 1f6:	81 2f       	mov	r24, r17
 1f8:	89 df       	rcall	.-238    	;  0x10c
 1fa:	21 97       	sbiw	r28, 0x01	; 1
 1fc:	b1 f7       	brne	.-20     	;  0x1ea
 1fe:	df 91       	pop	r29
 200:	cf 91       	pop	r28
 202:	1f 91       	pop	r17
 204:	0f 91       	pop	r16
 ...
 25a:	ff 90       	pop	r15
 25c:	ef 90       	pop	r14
 25e:	51 cf       	rjmp	.-350    	;  0x102
 260:	cf 93       	push	r28
 262:	df 93       	push	r29
 264:	ec 01       	movw	r28, r24
 266:	89 91       	ld	r24, Y+
 268:	88 23       	and	r24, r24
 26a:	11 f0       	breq	.+4      	;  0x270
 26c:	cf df       	rcall	.-98     	;  0x20c
 26e:	fb cf       	rjmp	.-10     	;  0x266
 270:	df 91       	pop	r29
 272:	cf 91       	pop	r28
 274:	08 95       	ret
 276:	cf 93       	push	r28
 ...
 288:	f1 f7       	brne	.-4      	;  0x286
 28a:	00 c0       	rjmp	.+0      	;  0x28c
 28c:	00 00       	nop
 28e:	70 df       	rcall	.-288    	;  0x170
 290:	8f e0       	ldi	r24, 0x0F	; 15
 292:	97 e2       	ldi	r25, 0x27	; 39
 294:	01 97       	sbiw	r24, 0x01	; 1
 296:	f1 f7       	brne	.-4      	;  0x294
 298:	00 c0       	rjmp	.+0      	;  0x29a
 29a:	00 00       	nop
 29c:	20 e0       	ldi	r18, 0x00	; 0
 29e:	40 e0       	ldi	r20, 0x00	; 0
 2a0:	60 e0       	ldi	r22, 0x00	; 0
 2a2:	80 e0       	ldi	r24, 0x00	; 0
 2a4:	92 df       	rcall	.-220    	;  0x1ca
 ...
 2ce:	80 91 64 00 	lds	r24, 0x0064	;  0x800064
 2d2:	90 91 65 00 	lds	r25, 0x0065	;  0x800065
 2d6:	8d 32       	cpi	r24, 0x2D	; 45
 2d8:	91 40       	sbci	r25, 0x01	; 1
 2da:	c0 f3       	brcs	.-16     	;  0x2cc
 2dc:	80 91 62 00 	lds	r24, 0x0062	;  0x800062
 2e0:	90 91 63 00 	lds	r25, 0x0063	;  0x800063
 2e4:	60 91 64 00 	lds	r22, 0x0064	;  0x800064
 2e8:	70 91 65 00 	lds	r23, 0x0065	;  0x800065
 2ec:	51 d0       	rcall	.+162    	;  0x390
 2ee:	70 93 61 00 	sts	0x0061, r23	;  0x800061
 2f2:	60 93 60 00 	sts	0x0060, r22	;  0x800060
 2f6:	10 92 65 00 	sts	0x0065, r1	;  0x800065
 2fa:	10 92 64 00 	sts	0x0064, r1	;  0x800064
 2fe:	10 92 63 00 	sts	0x0063, r1	;  0x800063
 302:	10 92 62 00 	sts	0x0062, r1	;  0x800062
 306:	83 ed       	ldi	r24, 0xD3	; 211
 308:	90 e3       	ldi	r25, 0x30	; 48
 30a:	01 97       	sbiw	r24, 0x01	; 1
 30c:	f1 f7       	brne	.-4      	;  0x30a
 30e:	00 c0       	rjmp	.+0      	;  0x310
 310:	00 00       	nop
 312:	80 91 60 00 	lds	r24, 0x0060	;  0x800060
 316:	90 91 61 00 	lds	r25, 0x0061	;  0x800061
 31a:	b8 01       	movw	r22, r16
 31c:	39 d0       	rcall	.+114    	;  0x390
 31e:	80 5d       	subi	r24, 0xD0	; 208
 320:	8b 83       	std	Y+3, r24	; 0x03
 322:	80 91 60 00 	lds	r24, 0x0060	;  0x800060
 326:	90 91 61 00 	lds	r25, 0x0061	;  0x800061
 32a:	b8 01       	movw	r22, r16
 32c:	31 d0       	rcall	.+98     	;  0x390
 32e:	cb 01       	movw	r24, r22
 330:	b8 01       	movw	r22, r16
 332:	2e d0       	rcall	.+92     	;  0x390
 334:	80 5d       	subi	r24, 0xD0	; 208
 336:	8a 83       	std	Y+2, r24	; 0x02
 338:	80 91 60 00 	lds	r24, 0x0060	;  0x800060
 33c:	90 91 61 00 	lds	r25, 0x0061	;  0x800061
 340:	84 36       	cpi	r24, 0x64	; 100
 342:	91 05       	cpc	r25, r1
 344:	10 f4       	brcc	.+4      	;  0x34a
 346:	d9 82       	std	Y+1, r13	; 0x01
 348:	0b c0       	rjmp	.+22     	;  0x360
 34a:	80 91 60 00 	lds	r24, 0x0060	;  0x800060
 34e:	90 91 61 00 	lds	r25, 0x0061	;  0x800061
 352:	b7 01       	movw	r22, r14
 354:	1d d0       	rcall	.+58     	;  0x390
 356:	cb 01       	movw	r24, r22
 358:	b8 01       	movw	r22, r16
 35a:	1a d0       	rcall	.+52     	;  0x390
 35c:	80 5d       	subi	r24, 0xD0	; 208
 35e:	89 83       	std	Y+1, r24	; 0x01
 360:	68 e0       	ldi	r22, 0x08	; 8
 362:	88 e2       	ldi	r24, 0x28	; 40
 364:	18 df       	rcall	.-464    	;  0x196
 366:	ce 01       	movw	r24, r28
 368:	01 96       	adiw	r24, 0x01	; 1
 36a:	7a df       	rcall	.-268    	;  0x260
 36c:	af cf       	rjmp	.-162    	;  0x2cc
 36e:	00 24       	eor	r0, r0
 370:	55 27       	eor	r21, r21
 372:	04 c0       	rjmp	.+8      	;  0x37c
 374:	08 0e       	add	r0, r24
 376:	59 1f       	adc	r21, r25
 378:	88 0f       	add	r24, r24
 37a:	99 1f       	adc	r25, r25
 37c:	00 97       	sbiw	r24, 0x00	; 0
 37e:	29 f0       	breq	.+10     	;  0x38a
 380:	76 95       	lsr	r23
 382:	67 95       	ror	r22
 384:	b8 f3       	brcs	.-18     	;  0x374
 386:	71 05       	cpc	r23, r1
 388:	b9 f7       	brne	.-18     	;  0x378
